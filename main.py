...
@app.route('/')
def home():
    return "Slowed & Reverb Bot with FFmpeg is alive!"
...
def process_audio(message):
    ...
    # Local ffmpeg path set karna zaroori hai agar current folder mein hai
...
if __name__ == "__main__":
    ...
    print("Slowed & Reverb Bot with FFmpeg is running...")
